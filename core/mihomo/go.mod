...
replace github.com/RyuaNerin/go-krypto => ./openharmony_shims/modules/go-krypto

replace github.com/enfein/mieru/v3 => ./openharmony_shims/modules/mieru

replace github.com/klauspost/cpuid/v2 => ./openharmony_shims/cpuid

replace github.com/metacubex/gvisor => ./openharmony_shims/modules/gvisor
