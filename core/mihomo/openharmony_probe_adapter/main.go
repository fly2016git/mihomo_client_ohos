...
import (
	...
	_ "github.com/metacubex/mihomo/adapter"
	_ "github.com/metacubex/mihomo/adapter/outbound"
	_ "github.com/metacubex/mihomo/adapter/outboundgroup"
	_ "github.com/metacubex/mihomo/adapter/provider"
)

//export MihomoOhosVersion
func MihomoOhosVersion() *C.char { return C.CString("adapter-probe") }
